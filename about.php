...
<body>
 <!--[if lte IE 9]>
  ...
  <![endif]-->
	...
	<div class="page-banner-area bg-4">
		<div class="container">
				...
				<div class="col-sm-12">
					<div class="testimonial-items style-2 carousel-two arrow-none z-index">
						<div class="single-testimonial style-2 style-3">
							...
							<h4>Prabath Madhawa</h4>
							<small>Cossfit Gym</small>
						...
						<div class="single-testimonial style-2 style-3">
							...
							<h4>C.M.Dissanayake</h4>
							<small>ACBT College</small>
							<div class="testimonial-text">
